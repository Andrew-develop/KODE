...
final class RecipesViewController: UIViewController {
    ...
    required convenience init(viewModel: RecipesViewModel) {
    ...
    private func setUpSearchBar() {
        ...
        searchBar.setRightImage(normalImage: UIImage(named: "filter") ?? UIImage(), highLightedImage: UIImage(named: "filter") ?? UIImage())
    }
